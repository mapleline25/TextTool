...
// See: https://github.com/CommunityToolkit/dotnet/blob/main/src/CommunityToolkit.Mvvm.SourceGenerators/Models/Result.cs.
//
// Summery of changes:
// 1. Fix the bug of stack overflow caused by the infinite recursion when calling object.Equals().
// 2. Add a 'Empty' field and a 'Length' property for use of this project.
    ...
    where T : IEquatable<T>
{
    ...
    // Add a static Empty field for use of other components.
    public static readonly EquatableArray<T> Empty = [];

    // Add a Length property for use of other components.
    public int Length
    {
    ...
    {
        // Use Equals(array) instead of Equals(this, array) to avoid infinite recursion.
